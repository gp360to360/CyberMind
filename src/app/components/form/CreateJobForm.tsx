...
// Removed ToastContainer import as it's now global
...
export default function CreateJobForm({ onClose }) {
  ...
  const onSubmit = async (data) => {
    const payload = { ...data, jobDescription: data.description };
    ...
    try {
      ...
      const response = await axios.post("http://localhost:3000/jobs", payload);
