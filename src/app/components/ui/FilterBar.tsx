  ...
  <div className="w-full bg-white rounded-lg mt">
    <div className="grid grid-cols-1 md:grid-cols-4 items-center gap-4">
      ...
      <div className="flex items-center space-x-3 p-2 border-r border-gray-200">
        ...
        <select className="w-full bg-transparent focus:outline-none text-gray-700 appearance-none">
      ...
      <div className="p-2">
        <div className="flex justify-between items-center mb-2">
          ...
          <span className="text-sm font-bold text-black">₹50k - ₹80k</span>
        </div>
        <div className="relative pt-1">
          ...
          <div className="relative w-full h-0.5 bg-gray-300 rounded-full">
            ...
            {/* Left handle */}
            <div
              className="absolute w-4 h-4 bg-black border-2 border-black rounded-full -top-1.5 transform -translate-x-1/2 flex items-center justify-center"
              style={{ left: "0%" }}
            >
              {/* White inner circle */}
